    ...
    return(
        <svg role="img" height={size} width={size} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16">
           <path d="M6 2.75C6 1.784 6.784 1 7.75 1h6.5c.966 0 1.75.784 1.75 1.75v10.5A1.75 1.75 0 0114.25 15h-6.5A1.75 1.75 0 016 13.25V2.75zm1.75-.25a.25.25 0 00-.25.25v10.5c0 .138.112.25.25.25h6.5a.25.25 0 00.25-.25V2.75a.25.25 0 00-.25-.25h-6.5zm-6 0a.25.25 0 00-.25.25v6.5c0 .138.112.25.25.25H4V11H1.75A1.75 1.75 0 010 9.25v-6.5C0 1.784.784 1 1.75 1H4v1.5H1.75zM4 15H2v-1.5h2V15z"
            fill="currentColor"/>
            <path d="M13 10a2 2 0 11-4 0 2 2 0 014 0zm-1-5a1 1 0 11-2 0 1 1 0 012 0z"
             fill="currentColor"/>
       </svg>
    )
}
...
const PictureInPictureIcon = ({size}) =>{
    return(
        <svg role="img" height={size} width={size} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16">
           <g fill="currentColor" fill-rule="evenodd"><path d="M1 3v9h14V3H1zm0-1h14a1 1 0 0 1 1 1v10a1 1 0 0 1-1 1H1a1 1 0 0 1-1-1V3a1 1 0 0 1 1-1z" fill-rule="nonzero"/><path d="M10 8h4v3h-4z"/></g>
       </svg>
    )
}
...
const Icon = ({name, size=24}) =>{
    const icons = {
        ...
        playIcon: PlayIcon,
        pauseIcon: PauseIcon,
        playPrevIcon: PlayPrevIcon,
        playNextIcon: PlayNextIcon,
        shuffleIcon: ShuffleIcon,
        repeatIcon: RepeatIcon,
        queueIcon: QueueIcon,
        deviceIcon: DeviceIcon,
        pictureIn: PictureInPictureIcon,
